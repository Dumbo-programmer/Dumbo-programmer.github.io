...
const EducationTimeline = () => {
  return (
    <div className="w-full max-w-5xl mx-auto py-20 relative">
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 h-full w-1 bg-white/20 hidden md:block" />
      ...
      {educationData.map((item, index) => (
        <motion.div
          ...
          className="w-full md:w-1/2 px-6 py-4 relative z-10 md:px-6 md:py-4"
          style={index % 2 === 0 ? { marginLeft: "auto" } : { marginRight: "auto" }}
        >
